...
class JobStoreTests(unittest.TestCase):
    ...
    def test_docs_match_confirmed_ctl_contract(self) -> None:
        ...
        for name in ("README.md", "PANORAMIX_OPERATIONAL.md"):
            ...
            self.assertIn("3a164cd125b77f81700d1a1e41c37bf385b05381", text, name)
            self.assertIn("28437ea", text, name)
        ...
        self.assertIn("3a164cd125b77f81700d1a1e41c37bf385b05381", ux)
        self.assertIn("28437ea", ux)
