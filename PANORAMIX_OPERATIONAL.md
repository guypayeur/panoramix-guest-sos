...
| Pretend cancel/fail auto-retries or resume-from-failed | **Rejected** — recoverability is handoff + payload for operator/ctl `reserve-temporal admit --handoff JSON`; pause/resume stays durable-only; stub `409 stub_only` |
