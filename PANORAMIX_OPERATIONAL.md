...
| Call the event trail a SIEM / regulatory audit / iec `/v1/audit/events` product | **Rejected** — durable reserve-temporal JSONL when hooked (survives runtime restart); else process-memory; not SIEM, not six-month compliance |
