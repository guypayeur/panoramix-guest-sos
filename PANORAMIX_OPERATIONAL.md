...
| Invent wall times / ETA without prior jobs in guest history | **Rejected** — compare uses created/updated on list/get identity; typical/ETA only from succeeded priors when two or more samples exist; empty/single-prior stay honest |
