...
Local reserve demo is a UX seed stub only (not IFRS17 math; named iec
baseline remains reserve_ifrs17). Compute engines stay in
panoramix-runtime bindings. Does not close #70.
"""
