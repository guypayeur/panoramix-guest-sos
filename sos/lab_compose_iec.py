...
# panoramix-runtime main tip after #161 GPU class (docs/iec-local.md).
# Method pin is iec 89fd962 lockstep (runtime pin PR may follow).
RUNTIME_IEC_PIN = "0baa3544e97ebde170e42ef172e69786360c8fad"
